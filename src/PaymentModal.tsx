...
const translationsMap = {
    en: {
        ...
        thankYouForSupportingFiveMaster: "Thank you for supporting Five&nbsp;Master!",
    ...
    useEffect(() => {
        const messageHandler = (e: any) => {
            ...
            if (
                ...
                localStorage.setItem("fivemaster.co:license_key", data.license_key);
            }
        };
                ...
                {showPaymentSuccess ? (
                    ...
                    >
                        ...
                        >
                            ...
                            {translations.thankYouForSupportingFiveMaster}
                        </div>
                    ...
                    <>
                        ...
                        <Button
                            href="https://zaidmukaddam.gumroad.com/l/eqtpc?wanted=true"
