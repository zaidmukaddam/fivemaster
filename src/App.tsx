...
export default function App() {
  ...
  const [isPremium, _setIsPremium] = useState(
    localStorage.getItem("fivemaster.co:cachedIsPremium") === "true"
  );
  ...
  useEffect(() => {
    const key = localStorage.getItem("fivemaster.co:license_key");
    if (key) {
